...
Public Class PUSH
    ...
    Try
        Using p As New System.Net.NetworkInformation.Ping()
            Dim r As System.Net.NetworkInformation.PingReply = p.Send(host, 1000)
...
End Function
    ...
    Private Async Sub ComboBoxSucursales_TextChanged(sender As Object, e As EventArgs) Handles ComboBoxSucursales.TextChanged
    ' Proceso cuando el usuario escribe manualmente (async)
    Await ProcesarSucursalAsync()
End Sub
    ...
    Private Sub TextBoxLegajo_TextChanged(sender As Object, e As EventArgs) Handles TextBoxLegajo.TextChanged
        ...
        If Regex.IsMatch(legajoActual, "^[NTE]\d{5}$", RegexOptions.IgnoreCase) Then
            ...
            If Await HacerPingAsync(puestoActual) Then
                Try
